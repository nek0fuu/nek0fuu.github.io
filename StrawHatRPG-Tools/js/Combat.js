...
function calculateDefense()
{
    ...
    switch(tekkai)
        {
            case "TK1":TekkaiFlat=10;TekkaiMult=0.15;stamReq=70;Tekkaithr=100;break; //.175
            case "TK2":TekkaiFlat=20;TekkaiMult=0.25;stamReq=135;Tekkaithr=200;break;//.250
            case "TK3":TekkaiFlat=30;TekkaiMult=0.35;stamReq=200;Tekkaithr=300;break;//.325
            case "TKP":TekkaiFlat=40;TekkaiMult=0.45;stamReq=265;Tekkaithr=500;break;//.400
