...
function calculateDefense()
{
    ...
    var stamFactor=.3,willFactor=0.1;
    var overflow=.25;
    ...
    switch(tekkai)
        {
            case "TK1":TekkaiMult=0.200;break;
            case "TK2":TekkaiMult=0.300;break;
            case "TK3":TekkaiMult=0.400;break;
            case "TKS":TekkaiMult=0.400+tspec/100;break;
            default:TekkaiMult=0;break;
        }
    switch(haki)
        {
            case "HC1":HakiMult=0.300;break;
            case "HC2":HakiMult=0.400;break;
            case "HC3":HakiMult=0.500;break;
            case "HCS":HakiMult=0.500+hspec/100;break;    
            default:HakiMult=0;break;
        }
    TekkaiMin=TekkaiMult*600;
    HakiMin=HakiMult*600;
    
    HakiBoost=HakiMult*basewill;
    TekkaiBoost=TekkaiMult*basestam;
    ...
    document.getElementById("totMit").textContent=Math.round(totMit);
...
function mitigate(power,hardness)
{
    ...
    minblock=.1+hardness/1000*.3;
    maxblock=.6+hardness/1000*.3;
    if(minblock>.4)
        {
            minblock=.4
        }
